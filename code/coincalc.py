...
from constants import TEAM_NAME_MAP, FIRST_PICK_COINS_COEF, SECOND_PICK_COINS_COEF, THIRD_PICK_COINS_COEF, FOURTH_PICK_COINS_COEF, NO_PLAYOFFS_BONUS, ROUND_1_LOSS_COEF, ROUND_2_LOSS_COEF, ROUND_3_LOSS_COEF, FINAL_LOSS_COEF, CHAMPION_COEF
